...
import type { MiningAbi, MiningAbiInterface, Miner } from "../MiningAbi";
...
export class MiningAbi__factory {
  static readonly abi = _abi;
  static createInterface(): MiningAbiInterface {
    return new utils.Interface(_abi) as MiningAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MiningAbi {
    return new Contract(address, _abi, signerOrProvider) as MiningAbi;
  }
}
